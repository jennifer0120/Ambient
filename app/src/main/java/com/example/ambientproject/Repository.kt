...
class Repository {
    companion object {
        private var initialDataList = listOf (
            Data("simple_rain", "Rain", R.drawable.rain, R.raw.base_after_base, false),
            Data("rain_on_lake", "Rain Falling on Lake", R.drawable.rain_falling_on_lake, R.raw.base_after_base, false),
