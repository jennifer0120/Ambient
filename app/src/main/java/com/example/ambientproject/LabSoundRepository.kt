...
class LabSoundRepository {
    companion object {
        private var initialDataList = listOf (
            LabSound("simple_rain", "Rain", R.drawable.jennifer_leaf, "https://firebasestorage.googleapis.com/v0/b/ambient-20983.appspot.com/o/Shirly%20Spikes%20-%20Natures%20Wrath%20-%20Light%20Rain%20Dripping%20in%20the%20Street.aac?alt=media&token=593d8bf9-53dc-48a1-bc2e-e32004d0491d", "rain_series"),
