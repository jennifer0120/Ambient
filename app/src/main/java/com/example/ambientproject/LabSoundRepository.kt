...
data class LabSound(val id: String, val name: String, val image: Int, val rawSongId: String, val group: String)

class LabSoundRepository {
    companion object {
        private var initialDataList = listOf (
            LabSound("simple_rain", "Rain", R.drawable.jennifer_leaf, "https://firebasestorage.googleapis.com/v0/b/ambient-44bf8.appspot.com/o/Alexander%20Gastrell%20-%20Australian%20Ambiences%20-%20Interior%20Perspective%2C%20Light%20Rain%2C%20Breeze.aac?alt=media&token=9e767d41-e92b-468e-a86d-c4364e70213d", "rain_series"),
            LabSound("rain_on_lake", "Rain Falling on Lake", R.drawable.jennifer_rain,"https://firebasestorage.googleapis.com/v0/b/ambient-20983.appspot.com/o/Dauzkobza%20-%20Natural%20Rainfall%20-%20Rain%20Falling%20on%20Lake.aac?alt=media&token=8e68edf9-3bce-4102-a0e5-644030111529", "rain_series"),
